...
const mealPrepper=(pantry,i, meals)=>{
  let meal = []
   pantry.map(ingredientCatergory=>{
  meal.push(ingredientCatergory[i]);
  return meal
  })
  meals.push(meal)
}
...
for ( let i = 0; i < strings.length; i++){
  newPassword.push(string1[i])
  newPassword.push(string2[i])
